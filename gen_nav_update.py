...
- Includes Open Source and Blog directly in top navigation bar across all pages.
- Complete IT & AI Services scope.
"""
...
<a href="https://instagram.com/axonflowai.in" class="ef-social-btn" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1"/></svg></a>
...
# OPEN SOURCE PAGE
open_source_page = HEAD("Open Source Contributions | AxonFlow AI",
    "Explore open-source repositories, AI toolkits, and infrastructure utilities built and maintained by AxonFlow AI engineers.",
    "/open-source") + """
<section class="page-hero">
<div class="wrap inner">
<div class="ef-eyebrow" style="margin-bottom:1.5rem">Community & Open Code</div>
<h1 class="hero-h1">Open Source <br><span class="accent">Tools & Repos.</span></h1>
<p class="hero-p">We believe in building in the open. Explore developer frameworks, vector database connectors, and AI agent orchestrators maintained by our team.</p>
<div class="cta-row">
<a href="https://github.com/saurabhhhcodes" class="ef-btn-primary" target="_blank">View GitHub Repos &rarr;</a>
</div>
</div>
</section>

<div class="ef-rail wrap" style="padding-left:1.5rem;padding-right:1.5rem">
<span><span class="dot-live"></span>4 Public Frameworks</span>
<span>&middot;</span><span>MIT Licensed Code</span>
<span>&middot;</span><span>Active Community Support</span>
</div>

<section class="section">
<div class="wrap">
<h2 class="section-title">Featured <span class="accent">Repositories</span></h2>
<div class="grid-2" style="gap:2rem;margin-bottom:4rem">
<div class="card" style="padding:2.5rem">
<span class="tag" style="margin-bottom:1rem;display:inline-block">TypeScript / Node</span>
<h3 class="card-h" style="font-size:1.4rem">AxonFlow Agent SDK</h3>
<p class="card-p" style="margin-bottom:1.5rem">Lightweight TypeScript SDK for orchestrating autonomous AI agent chains with automatic state persistence and streaming UI support.</p>
<a href="https://github.com/saurabhhhcodes" target="_blank" style="color:var(--accent);font-size:.9rem;font-weight:600">Explore on GitHub &rarr;</a>
</div>

<div class="card" style="padding:2.5rem">
<span class="tag" style="margin-bottom:1rem;display:inline-block">Python / FastAPI</span>
<h3 class="card-h" style="font-size:1.4rem">FastRAG Vector Middleware</h3>
<p class="card-p" style="margin-bottom:1.5rem">High-throughput RAG search middleware integrating Pinecone, Qdrant, and Cohere re-ranking with sub-300ms latency guarantees.</p>
<a href="https://github.com/saurabhhhcodes" target="_blank" style="color:var(--accent);font-size:.9rem;font-weight:600">Explore on GitHub &rarr;</a>
</div>

<div class="card" style="padding:2.5rem">
<span class="tag" style="margin-bottom:1rem;display:inline-block">Docker & DevOps</span>
<h3 class="card-h" style="font-size:1.4rem">Cloud-Deploy Stack</h3>
<p class="card-p" style="margin-bottom:1.5rem">Zero-config Docker Compose templates for deploying self-hosted N8N, PostgreSQL, Redis, and Caddy reverse proxy with Let's Encrypt.</p>
<a href="https://github.com/saurabhhhcodes" target="_blank" style="color:var(--accent);font-size:.9rem;font-weight:600">Explore on GitHub &rarr;</a>
</div>

<div class="card" style="padding:2.5rem">
<span class="tag" style="margin-bottom:1rem;display:inline-block">Python</span>
<h3 class="card-h" style="font-size:1.4rem">Smart Doc Extractor</h3>
<p class="card-p" style="margin-bottom:1.5rem">Open-source PDF & OCR document parsing engine optimized for financial invoices, legal contracts, and structured tabular data.</p>
<a href="https://github.com/saurabhhhcodes" target="_blank" style="color:var(--accent);font-size:.9rem;font-weight:600">Explore on GitHub &rarr;</a>
</div>
</div>
</div>
...
write_both("open-source/index.html", open_source_page)

# Update BLOG PAGE
blog_page = HEAD("Engineering Blog & Technical Insights | AxonFlow AI",
    "Deep dives on cloud infrastructure, DevOps pipelines, multi-agent AI architecture, and full-stack software development.",
    "/blog") + """
<section class="page-hero">
<div class="wrap inner">
...
<p class="hero-p">Insights from our software developers and cloud architects on building production-grade software and autonomous AI systems.</p>
</div>
</section>
...
<h3 class="card-h">Architecting Zero-Downtime Kubernetes Pipelines</h3>
<p class="card-p">A step-by-step guide to blue-green deployments, ingress routing, and automated rollback strategies for enterprise microservices.</p>
</div>

<div class="card">
<span class="tag" style="margin-bottom:1rem;display:inline-block">AI Systems</span>
<h3 class="card-h">Building Sub-400ms Production RAG Pipelines</h3>
<p class="card-p">How we combined hybrid vector search with Cohere re-ranking to deliver semantic legal & medical search at scale.</p>
</div>

<div class="card">
<span class="tag" style="margin-bottom:1rem;display:inline-block">DevOps & Automation</span>
<h3 class="card-h">Self-Hosted N8N Workflows for Enterprise ERP</h3>
<p class="card-p">Integrating webhook triggers, database mutations, and automated notification loops for seamless back-office operations.</p>
</div>
</div>
</div>
</section>
...
write_both("blog/index.html", blog_page)

print("Updated nav header with Open Source & Blog across all pages!")
