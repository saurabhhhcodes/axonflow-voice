...
<p class="hero-p" style="max-width:48ch;margin-bottom:0">Submit your project requirements or student internship proposal to get connected with our lead engineering team.</p>
</div>

<!-- Futuristic Vertical Video Masked Brand Typography (Apple Style) -->
<div class="futuristic-brand-vertical-container" style="position:relative;height:380px;display:flex;align-items:center;justify-content:center;overflow:hidden;border-left:1px solid var(--border);padding-left:1.5rem">
  <!-- Video element playing nature video -->
  <video autoplay loop muted playsinline style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:0;pointer-events:none"></video>
  
  <div class="brand-text-vertical-wrapper" style="position:relative;width:100%;height:100%;display:flex;align-items:center;justify-content:center">
    <!-- SVG with Mask for Video inside Text -->
    <svg viewBox="0 0 200 600" preserveAspectRatio="xMidYMid meet" style="width:100%;height:100%;max-height:360px;filter:drop-shadow(0 0 25px rgba(84,87,255,0.4))">
      <defs>
        <mask id="brandTextMask">
          <rect width="100%" height="100%" fill="black" />
          <text x="50%" y="50%" text-anchor="middle" dominant-baseline="central" 
                transform="rotate(-90, 100, 300)"
                font-family="Fraunces, serif" font-weight="900" font-size="64" letter-spacing="4" fill="white">
            AXONFLOW AI
          </text>
        </mask>
        <!-- Gradient overlay -->
        <linearGradient id="textGlow" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#5457ff" stop-opacity="0.8" />
          <stop offset="50%" stop-color="#35d07f" stop-opacity="0.8" />
          <stop offset="100%" stop-color="#7f81ff" stop-opacity="0.8" />
        </linearGradient>
      </defs>
      
      <!-- Video / Animated Mask Container -->
      <foreignObject width="100%" height="100%" mask="url(#brandTextMask)">
        <div xmlns="http://www.w3.org/1999/xhtml" style="width:100%;height:100%;position:relative;overflow:hidden">
          <video autoplay="autoplay" loop="loop" muted="muted" playsinline="playsinline" 
            ...
            <source src="/assets/hero_nature.mp4" type="video/mp4" />
          </video>
        </div>
      </foreignObject>

      <!-- Glowing border outline of letters -->
      <text x="50%" y="50%" text-anchor="middle" dominant-baseline="central" 
            transform="rotate(-90, 100, 300)"
            font-family="Fraunces, serif" font-weight="900" font-size="64" letter-spacing="4" 
            fill="none" stroke="url(#textGlow)" stroke-width="1.5" opacity="0.6">
        AXONFLOW AI
      </text>
    </svg>
  </div>
