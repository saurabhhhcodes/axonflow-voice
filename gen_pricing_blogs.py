...
<div class="card" style="display:flex;flex-direction:column;justify-content:space-between;border-color:var(--accent);position:relative">
<div style="position:absolute;top:-12px;right:20px;background:var(--accent);color:#fff;font-size:.65rem;font-family:var(--font-mono);letter-spacing:.08em;padding:.2rem .75rem;border-radius:10px;text-transform:uppercase">Most Popular</div>
<div>
